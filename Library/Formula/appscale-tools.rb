...
class AppscaleTools < Formula
  ...
  def install
    ...
    python do
      ...
      system 'curl https://gist.github.com/hanxue/7529824/raw/47bd1721f3f6d7f66a63eea94b1e3136fe55eb31/appscale-tools.patch > appscale-tools.patch'
      system 'patch', '-f', '-p0', '-i', 'appscale-tools.patch' 
